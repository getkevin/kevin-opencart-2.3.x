...
*/
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('extension/module/kevin_refund', 'token='.$this->session->data['token'].$url, true),
        ];

        //	$data['invoice'] = $this->url->link('extension/module/kevin_refund/invoice', 'token=' . $this->session->data['token'], true);
        ...
        foreach ($results as $result) {
            ...
            //	'amount_available'      => $this->currency->format((float)$result['amount_available'], $result['currency_code'], $currency_value),
                ...
                'view' => $this->url->link('extension/module/kevin_refund/info', 'token='.$this->session->data['token'].'&order_id='.$result['order_id'].$url, true),
                'refund_kevin' => $this->url->link('extension/module/kevin_refund/refundKevin', 'token='.$this->session->data['token'].'&order_id='.$result['order_id'].$url, true),
            ];
        }
...
*/
        ...
        $data['sort_order'] = $this->url->link('extension/module/kevin_refund', 'token='.$this->session->data['token'].'&sort=o.order_id'.$url, true);
        $data['sort_customer'] = $this->url->link('extension/module/kevin_refund', 'token='.$this->session->data['token'].'&sort=customer'.$url, true);
        $data['sort_status'] = $this->url->link('extension/module/kevin_refund', 'token='.$this->session->data['token'].'&sort=order_status'.$url, true);
        $data['sort_total'] = $this->url->link('extension/module/kevin_refund', 'token='.$this->session->data['token'].'&sort=o.total'.$url, true);
        $data['sort_total_amount'] = $this->url->link('extension/module/kevin_refund', 'token='.$this->session->data['token'].'&sort=total_amount'.$url, true);
        $data['sort_amount_available'] = $this->url->link('extension/module/kevin_refund', 'token='.$this->session->data['token'].'&sort=amount_available'.$url, true);
        $data['sort_refund_action'] = $this->url->link('extension/module/kevin_refund', 'token='.$this->session->data['token'].'&sort=return_action'.$url, true);
        $data['sort_date_added'] = $this->url->link('extension/module/kevin_refund', 'token='.$this->session->data['token'].'&sort=o.date_added'.$url, true);
        $data['sort_date_modified'] = $this->url->link('extension/module/kevin_refund', 'token='.$this->session->data['token'].'&sort=o.date_modified'.$url, true);
...
*/
        ...
        $pagination->url = $this->url->link('extension/module/kevin_refund', 'token='.$this->session->data['token'].$url.'&page={page}', true);
...
*/
        ...
        if ($order_info) {
            ...
            $data['refund_kevin'] = $this->url->link('extension/module/kevin_refund/refundKevin', 'token='.$this->session->data['token'].'&refund_info=1&order_id='.$order_id.$url, true);
...
*/
            ...
            //	$data['invoice'] = $this->url->link('extension/module/kevin_refund/invoice', 'token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'], true);

            $data['cancel'] = $this->url->link('extension/module/kevin_refund', 'token='.$this->session->data['token'].$url, true);
    ...
    public function refundKevin()
    {
        ...
        if (empty($refunds)) {
            ...
            $this->response->redirect($this->url->link('extension/module/kevin_refund', 'token='.$this->session->data['token'], true));
...
*/
        ...
        if (!empty($this->request->get['order_id']) && !empty($this->request->post['payment_id'])) {
            ...
            if (empty($this->request->post['kevin_refund_amount'])) {
                ...
                $this->KevinRefundLog($this->session->data['error_refund']);
                if ($refund_info) {
                    $this->response->redirect($this->url->link('extension/module/kevin_refund/info&order_id='.$order_id, 'token='.$this->session->data['token'], true));
                } else {
                    $this->response->redirect($this->url->link('extension/module/kevin_refund', 'token='.$this->session->data['token'].$url, true));
                }
            }
